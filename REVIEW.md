...
状态：本地代码、309 项自动化测试、Release 构建与严格签名均已复核。用户截图确认真实 Command Code API Key 能返回额度和用量；刷新结束后的持续显示修复已有回归测试，真实界面复验仍保留在验收台账。用户已授权发布 [Minget v1.2.0](https://github.com/ym911x/Minget/releases/tag/v1.2.0)。
