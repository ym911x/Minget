...
当前状态：发布验收、annotated tag、GitHub Release 和发布提交 CI 均已完成。
...
| GitHub 发布 | 通过 | 发布提交 `2d05344`；annotated tag `v1.4.1`；[正式 Release](https://github.com/ym911x/Minget/releases/tag/v1.4.1) 为非草稿、非预发布并标记 Latest；CI `35549933542` 成功 |
